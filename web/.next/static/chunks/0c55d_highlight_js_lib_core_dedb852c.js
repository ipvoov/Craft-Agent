...
"[project]/node_modules/.pnpm/highlight.js@10.7.3/node_modules/highlight.js/lib/core.js [app-client] (ecmascript)": ((__turbopack_context__) => {
 ...
 */ function join(regexps) {
    ...
    return regexps.map((regex)=>{
        ...
        return out;
    }).map((re)=>"(".concat(re, ")")).join(separator);
}
// Common regexps
 ...
 */ function compileKeywords(rawKeywords, caseInsensitive) {
    let className = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : DEFAULT_KEYWORD_CLASSNAME;
 ...
 */ function compileLanguage(language, param) {
    let { plugins } = param;
    /**
...
/* plugin itself */ /** @type {HLJSPlugin} */ const mergeHTMLPlugin = {
    "after:highlightElement": (param)=>{
        let { el, result, text } = param;
...
//# sourceMappingURL=0c55d_highlight_js_lib_core_dedb852c.js.map